...
submission.tex: manuscript.md pandoc/template-JASA-EL-submission.tex figures/fig-1.eps figures/fig-2.eps figures/fig-3.eps
...
manuscript.tex: manuscript.md pandoc/template-JASA-EL-manuscript.tex figures/fig-1.eps figures/fig-2.eps figures/fig-3.eps
