...
$if(abstract)$\begin{abstract}$abstract$\end{abstract}\bigskip\copyright $if(copyrightyear)$$copyrightyear$$endif$ Acoustical Society of America$if(pacs)$\bigskip\bigskip\bigskip PACS Numbers: $for(pacs)$$pacs$$sep$, $endfor$$endif$\newpage$endif$
